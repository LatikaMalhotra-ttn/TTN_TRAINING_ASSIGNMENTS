        ...
        return(
            <div className={classes.OrderContainer + " text-monospace card"}>
                    ...
                    <div style={{background:"white"}} 
                        className={classes.OrderedBurger 
                    ...
                    <i className='fas fa-chart-pie' style={{size:"35px",marginRight:"5px"}}></i>
                    ...
                    <ul  className="list-group">
                    {
                        ...
                        <li className="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <span className="badge badge-primary badge-pill">
                                {this.props.orderDetail.ingredients.Meat}
                            </span>
                        </li>
                        : null
                    }
                    {
                        ...
                        <li className="list-group-item d-flex justify-content-between align-items-center">
                            Bacon
                            <span className="badge badge-primary badge-pill">
                                {this.props.orderDetail.ingredients.Bacon}
                            </span>
                        </li>
                        : null
                    }
                    {
                        ...
                        <li className="list-group-item d-flex justify-content-between align-items-center">
                            Salad
                            <span className="badge badge-primary badge-pill">
                                {this.props.orderDetail.ingredients.Salad}
                            </span>
                        </li>
                        : null
                    }
                    {
                        ...
                        <li className="list-group-item d-flex justify-content-between align-items-center">
                            Cheese
                            <span className="badge badge-primary badge-pill">
                                {this.props.orderDetail.ingredients.Cheese}
                            </span>
                        </li>
                        : null
                    }
                         ...
                         <strong> Delivered To :</strong></p>
                    {
                        ...
                        <div className="border border-info" 
                            style={{color:"#5D6D7E",borderRadius:"5px",padding:"15px"}}>
                    ...
                    <img className={classes.Barcode} src={require("../../../assets/barcode.png")} alt=""/>
