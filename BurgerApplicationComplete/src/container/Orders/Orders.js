...
class Orders extends React.Component{
    ...
    populateOrders=()=>{
        ...
        for(let i=this.state.innerNavorderBeginCountNumber; i<this.state.innerNavorderBeginCountNumber+10;i++){
            ...
            ordersArr.push(<Order key={i} no={i}
                orderDetail= {obj} 
                />)
            }
    ...
    render(){
        return(
           ...
           <div style={{display:"flex",justifyContent:"center"}} className="pagination">
                    {
                        this.state.orderBeginCountNumber===0?
                        <div  className="page-item">
                            <p style={{background:"darkgray", color:"white"}} 
                                disabled={true} 
                                className="page-link">
                                    previous
                            </p>
                        ...
                        : <div className="page-item">
                            <p onClick={this.onPreviousClickHandler} 
                                class="page-link">
                                    previous
                            </p>
                        </div>
                ...
                <div 
                    className="page-item">
                        <p onClick={this.onFirstNavBtnClickHandler} 
                            style={this.state.pagePointer===1?{background:"#0275d8",color:"white"}:null } 
                             className="page-link">{this.state.firstPageNumber}
                        </p>
                </div>
                <div className="page-item">
                    <p onClick={this.onSecondNavBtnClickHandler} 
                        style={this.state.pagePointer===2?{background:"#0275d8",color:"white"}:null } 
                        className="page-link">{this.state.secondPageNumber}
                    </p>
                </div>
                <div className="page-item">
                    <p onClick={this.onThirdNavBtnClickHandler} 
                        style={this.state.pagePointer===3?{background:"#0275d8",color:"white"}:null }
                         className="page-link">{this.state.thirdPageNumber }
                    </p>
                </div>
                
                {
                    ...
                    <div className="page-item"><p onClick={this.onNextClickHandler} 
                        className="page-link">next</p>
                    </div>
                    : <div className="page-item">
                        <p style={{background:"darkgray",color:"white"}} 
                            disabled={true} className="page-link">
                                next
                        </p>
                        </div>
