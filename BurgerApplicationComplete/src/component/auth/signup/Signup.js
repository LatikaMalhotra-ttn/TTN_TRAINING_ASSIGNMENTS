...
let baseURL="https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyDOoGlhZmeONMaBj-22Fl_ArcBm_DVcLOQ"
...
class Signup extends React.Component{
    ...
    signupUser=(e)=>{
        ...
        if(this.state.formElements.password.value.length<8){
            this.setState({
                error:true,
                errorMsg:"Password must have 8 Characters !"
            })
            setTimeout(()=>{
