...
class BurgerBuilder extends Component{
    ...
    //------------------------------------------------>
    findPrice = ()=>{
            Object.keys(this.props.price).map((key)=>{
        ...
        .catch((error)=>{
            ...
            this.props.verifyErrorOccur({message:errormsg})
                ...
                this.setState({
                    alert:true,
                    alertIcon:"error.png",
                    alertMsg:"You need to login to make an order !!",
                    alertType:"danger"
                })
            ...
            <div className={classes.BurgerBuilderContainer +" text-monospace"}>
               {
                ...
                
                {
                    ...
                    this.checkIfAnySelected()?
                        <div className={classes.AroundBurger}> 
                            <Burger ingredients = {this.props.ingredients} /> 
                        </div>
                        :<div className={classes.AroundBurger}>
                            <Burger ingredients = {this.props.ingredients} >
                                <h6>Add ingredients of your choice!</h6>
                            </Burger>
                        </div>
                        : <Spinner />
                }

                {
                    ...
                    <OrderSummary  checkout={this.checkout} 
                        backdropClick={this.backdropClickForOrder} 
...

               {
                    ...
                    <React.Fragment> 
                        <Backdrop backdropClick={this.closeOrderUserDetailForm} /> 
                        <UserDetailForm giveInputValuesBack={this.bringFormDetailValues} 
                            submitForm={this.submitUserDetailForOrderForm} 
                            closeForm={this.closeOrderUserDetailForm}  
               ...
               }
               {
                ...
                <OrderNow disabledStatus={ !this.state.orderNowClickEligible} 
                 btnClick={this.orderNow} 
