            ...
            <div style={layoutCss}>
                {
                    ...
                    <React.Fragment> 
                        <Sidedrawer 
                            mobileView={this.state.menuStatus} 
                            closeMenu={this.closeMenu}    
                            toggleAuthPage={this.toggleAuthInMenuState} />
                        <Backdrop 
                           backdropClick={this.closeMenu} />
                    </React.Fragment> : null
                }
                <Toolbar  
                    auth={this.state.auth} 
                    toggleAuthPage={this.toggleAuthPage}  
                    openMenu={this.openMenu}/>
                {
                    this.state.menuAuth?
                    <React.Fragment> 
                        <Backdrop backdropClick={this.toggleAuthInMenuState} /> 
                        <Auth toggleAuthPage={this.toggleAuthInMenuState}  /> 
                    </React.Fragment>
                    :null
                }
                <DataBlock>
